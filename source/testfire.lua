...
Section:NewButton("Reach", "Makes you hit from farther.", function()
    local active = true
...
Section:NewButton("TP Bypass (CTRL + Click)", "tp bypass", function()
...
game.RunService.RenderStepped:Connect(function()
    for i, v in pairs(game:GetService("Players"):GetChildren()) do
        if v.Character and v.Character:FindFirstChild("HumanoidRootPart") and v.Team ~= game.Players.LocalPlayer.Team then
            print(v.Name .. " is the current target!")
            repeat wait(0.2)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.Character.HumanoidRootPart.CFrame - Vector3.new(0,0,5)
