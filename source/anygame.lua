...
local Window = Library.CreateLib("Noboline | AnyGame", "DarkTheme")

-- Main
local Tab = Window:NewTab("Main")
local Section = Tab:NewSection("Main Scripts")

Section:NewButton("Infinite Yeild", "Exucutes Infinite Yeild", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

Section:NewSlider("Walkspeed", "walk faster :D", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

Section:NewButton("Infinite Jump", "Jumps inf times", function()
...
Section:NewButton("KillAura (Sword Fighting Games)", "Attacks players that come to you.", function()
    loadstring(game:HttpGet('https://pastebin.com/raw/VJUMhJfW'))()
end)

Section:NewButton("Reach (Sword Figting Games)", "Makes you hit from farther.", function()
    local active = true
